  ...
  return (
    <>
      ...
      <div className="flex items-center font-sans">
        <h1 className="text-3xl lg:text-4xl xl:text-6xl font-bold text-center md:text-left">
          {language === 'en' ? 'Create' : 'انشئ'}{" "}
          <AuroraText speed={1} colors={["#38BDF8", "#3B82F6", "#EC4899"]}>
            {language === 'en' ? 'beautiful' : 'أشياء'}
          </AuroraText>{" "}
          {language === 'en' ? 'things' : 'جميلة'}
        </h1>
      </div>
    </>
  );
